...
def resize_with_padding_pil(img, expected_size):
    """
    Resize PIL image keeping aspect ratio and using padding to achieve desired size
    
    Args:
        img: PIL.Image object
        expected_size: tuple(width, height) - desired output size
        
    Returns:
        PIL.Image object - resized and padded image
    """
    ...
    # Create new black image with padding
    padded = Image.new('RGB', (desired_w, desired_h), (0, 0, 0))
    
    # Paste resized image in center of padded image
